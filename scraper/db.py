"""SQLite store for scraped dentist listings."""
import sqlite3
import re
import unicodedata
...
# Non-dental noise that can surface in "emergency dentist"/"oral surgeon"
# searches. Dental CHAINS (Aspen Dental, Western Dental, etc.) are legitimate
# listings, so keep this list to clearly-irrelevant results only.
JUNK_NAMES = (
    "walmart", "cvs pharmacy", "walgreens", "target", "costco",
    "emergency room", "urgent care", "hospital",
)
