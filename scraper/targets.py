"""Search targets: dental specialties x US cities (NATIONWIDE).

Cities load from data/us-cities.csv (top ~1,000 US cities by population).
1,000 cities x 8 specialties = 8,000 search jobs. With CID dedup collapsing the
metro overlap, that yields tens of thousands of unique dental practices.
...
# Google Maps search phrase -> display specialty label.
CATEGORIES = [
