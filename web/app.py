...
app = Flask(__name__)
app.config["SITE_NAME"] = "Dentist Directory"
...
app.config["DOMAIN"] = os.environ.get(
    "DOMAIN", "https://dentistdirectory.vercel.app")
...
CATEGORY_ICONS = {
    "General Dentist": "fa-tooth",
    "Cosmetic Dentist": "fa-teeth",
    "Orthodontist": "fa-teeth-open",
    "Pediatric Dentist": "fa-child-reaching",
    "Oral Surgeon": "fa-user-doctor",
    "Endodontist": "fa-tooth",
    "Periodontist": "fa-teeth",
    "Emergency Dentist": "fa-kit-medical",
}
